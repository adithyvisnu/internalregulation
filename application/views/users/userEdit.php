        ...
        <form class="row" id="edit-user-form" method="post" action="">
          ...
          <div class="input-field col s12 m6">
              <select id="level" name="level">
                  ...
                  <option <?php echo ($user->level === 'karyawan') ? 'selected' : ''; ?> value="karyawan">Karyawan</option>
              </select>
          ...
          <div class="input-field col s12 right-align">
              <button type="submit" name="submit" value="<?php echo $user->id_user; ?>" class="btn amber waves-effect waves-green">Simpan</button>
          </div>
        </form>
      </div>
    </div>
